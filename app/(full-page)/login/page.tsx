...
const LoginPage = () => {
    ...
    const loginOktaClick = () => {
        router.push('https://944hdgxp-9000.inc1.devtunnels.ms/sbs/login');
    }
            ...
            <div className="flex align-items-center justify-between w-full h-screen">
                ...
                <div>
                    ...
                    >
                        ...
                        <Button label={'Log in with Okta'}  className="w-full bg-white border-primary mb-2 text-primary" onClick={loginOktaClick} />
