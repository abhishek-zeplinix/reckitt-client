...
const VersionMappingList = [
    ...
    },
    {
        bu: 'Essential Home',
        country: 'IT-Italy',
        version: 'Mexico Hygiene'
    },
    {
        bu: 'Hygiene',
        country: 'ES-Spain',
        version: 'Poland Health'
    },
    {
        bu: 'Health',
        country: 'AT-Austria',
        version: 'Vietnam Health'
    },
    {
        bu: 'Nutrition',
        country: 'DE-Germany',
...
function VersionMapping() {
    ...
    const [version, setVersion] = useState<any>('Original')
            ...
            <div className="inner p-4 border-1 surface-border border-round">
                <div className="flex flex-wrap justify-content-between align-items-center mb-2">
                    ...
                    <div className="flex flex-column">
                        <h2 className="m-0">Version Mapping</h2>
                    ...
                    <div className="flex flex-column gap-4 w-full border-1 border-round surface-border p-3 input-fields-add-new">
                        ...
                        <div className="flex flex-wrap w-full justify-content-between gap-4 ">
                            ...
                            <div className="flex flex-column gap-2" style={{ flex: '1 1 30%' }}>
                                ...
                                <InputText id="brandSegment" value={version} onChange={(e) => setVersion(e.target.value)} className="w-full" placeholder="Enter Version" />
                                {regionError && <small className="p-error">{regionError}</small>}
                            </div>
                ...
                <div className="mt-2">
                    {isFetchingRegions ? (
                        <TableSkeletonSimple columns={5} rows={10} />
                    ) : (
                        <CustomDataTable
                            ref={regionList}
                            page={page}
